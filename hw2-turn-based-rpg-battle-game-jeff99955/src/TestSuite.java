...
public class TestSuite {
    ...
    /**
     * Compile and run this TestSuite: 1. cd src/ 2. javac TestSuite.java -d ../out/
     * 3. cd .. 4. java -cp out/ TestSuite <testcase name>
     *
     * Or you can directly run `sh test.sh`. The script helps you do all the above.
     */
